...
select pp.BusinessEntityID,pp.FirstName,pbea.AddressID 
from Person.Person as pp
inner join
Person.BusinessEntityAddress as pbea
on pp.BusinessEntityID=pbea.BusinessEntityID;

select pp.BusinessEntityID,FirstName,pbea.BusinessEntityID,pbea.AddressID 
from Person.Person as pp
full outer join
Person.BusinessEntityAddress as pbea
on pp.BusinessEntityID=pbea.BusinessEntityID
--where pp.BusinessEntityID is NULL;
--where pbea.BusinessEntityID is NULL;
